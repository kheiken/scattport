...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<p><a href="javascript:void(0);" class="button inplace_save">Save</a>', // string: image button tag to use as “Save” button
	cancel_button:		'<a href="javascript:void(0);" class="button inplace_cancel">Cancel</a></p>', // string: image button tag to use as “Cancel” button
	params:				"", // string: example: first_name=dave&last_name=hauenstein extra paramters sent via the post request to the server
	field_type:			"textarea", // string: "text", "textarea", or "select";  The type of form field that will appear on instantiation
	...
	textarea_cols:		60, // integer: set cols attribute of textarea, if field_type is set to textarea. Use CSS if possible though
